...
public class Main {
    private static final Option library = Option.builder("lib")
            ...
            .desc("(Required) Java library to extract. Maven coordinate groupId:artifactId:version")
            .build();
    ...
    private static void printUsage(java.io.PrintStream out) {
        out.println("Usage: java -jar java-api-extractor.jar [command] [options]");
        out.println("Commands:");
        out.println("  extract: Extracts the API from the Java libraries");
    ...
    private static CommandLine parseOrExit(String[] args, Options options, String command) {
        try {
            ...
            new HelpFormatter().printHelp(
                    "java -jar java-api-extractor.jar " + command + " [options]", options);
            System.exit(1);
